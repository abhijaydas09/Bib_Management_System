  ...
  const renderTabForm = () => {
    if (activeTab === 0) {
      ...
      return (
        ...
        >
          <div style={{ width: 564, maxWidth: '95vw', display: 'flex', flexDirection: 'column', gap: 24 }}>
            <BasicTextInput name="email" placeholder="Email Address" value={form.email} onChange={handleChange} icon={<FaEnvelope />} style={{ width: 544 }} />
            <BasicTextInput name="phone" placeholder="Phone" value={form.phone} onChange={handleChange} icon={<FaPhone />} style={{ width: 544 }} />
            <BasicTextInput name="website" placeholder="Website" value={form.website} onChange={handleChange} icon={<FaGlobe />} style={{ width: 544}} />
